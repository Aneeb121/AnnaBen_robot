class script(object):
    START_TXT = """𝙷𝙴𝙻𝙾 {},
𝙼𝚢 𝚗𝚊𝚖𝚎 , <a href=https://t.me/Lucy_Autofilterbot > 𝙻𝚄𝙲𝙸𝙵𝙴𝚁 </a>, 𝙸𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 𝙼𝙾𝚅𝙸𝙴𝚂, 𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽... 𝚃𝙷𝙴𝙽 𝚂𝙴𝙴 𝙼𝚈 𝙿𝙾𝚆𝙴𝚁𝚂❤️🔥🔥
"""
    HELP_TXT = """𝙷𝙴𝚈 {}
𝘏𝘦𝘳𝘦 𝘐𝘴 𝘛𝘩𝘦 𝘏𝘦𝘭𝘱 𝘍𝘰𝘳 𝘔𝘺 𝘊𝘰𝘮𝘮𝘢𝘯𝘥𝘴."""
    ABOUT_TXT = """
𝗧𝗛𝗜𝗦 𝗜𝗦 𝑳𝑼𝑪𝑰𝑭𝑬𝑹  𝗔𝗕𝗢𝗨𝗧 𝗠𝗦𝗚
✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵
╔════❰ ꪖ᥇ꪮꪊ𝓽 ꪑ𝘴ᧁ ❱═❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣ 
║┣⪼ 𝙈𝙔 𝙉𝘼𝙈𝙀 - <a href="https://t.me/Lucy_Autofilterbot"> 𝑳𝑼𝑪𝑰𝑭𝑬𝑹 </a>
║┣⪼ Ⓓ︎Ⓔ︎Ⓥ︎ - <a href="https://t.me/psycho_009"> 𓄂𓆩𝙱𝙻𝙰𝙲𝙺 𝙳𝙴𝚅𝙸𝙻𓆪 </a>
║┣⪼ 𝓛𝓲𝓫𝓻𝓪𝓻𝓻𝔂 - 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
║┣⪼ 𝓛𝓪𝓷𝓰𝓾𝓪𝓰𝓮 - 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
║┣⪼ 𝓓𝓪𝓽𝓪 𝓑𝓪𝓼𝓮 - 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
║┣⪼ 𝓑𝓸𝓽 𝓼𝓮𝓻𝓿𝓮𝓻 -  𝙷𝙴𝚁𝙾𝙺𝚄
...
- ՏOᑌᖇᑕᗴ ᑕOᗪᗴ - <a href="https://github.com/Aneeb121/AnnaBen_robot"> 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 </a>

𝗠𝗔𝗦𝗧𝗘𝗥:
<a href="https://t.me/movies_channel001"> 𝕋𝕖𝕒𝕞𝕖 𝙾𝚃𝙼 </a>"""
